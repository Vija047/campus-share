        ...
        try {
            ...
            try {
                ...
                if (downloadUrl.startsWith('/uploads/')) {
                    ...
                    cleanDownloadUrl = `https://campus-share-backend.onrender.com${downloadUrl.startsWith('/') ? '' : '/'}${downloadUrl}`;
                }
            }
            ...
            try {
                ...
                try {
                    ...
                    if (viewUrl.startsWith('/uploads/')) {
                        ...
                        cleanViewUrl = `https://campus-share-backend.onrender.com${viewUrl.startsWith('/') ? '' : '/'}${viewUrl}`;
                    }
                }
                ...
                try {
                    ...
                    try {
                        ...
                        if (downloadUrl.startsWith('/uploads/')) {
                            ...
                            cleanFallbackUrl = `https://campus-share-backend.onrender.com${downloadUrl.startsWith('/') ? '' : '/'}${downloadUrl}`;
                        }
                    }
