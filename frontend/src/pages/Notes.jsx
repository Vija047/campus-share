        ...
        try {
            ...
            try {
                ...
                if (downloadUrl.startsWith('/uploads/')) {
                    ...
                    cleanDownloadUrl = `https://campus-share-zeta.vercel.app${downloadUrl.startsWith('/') ? '' : '/'}${downloadUrl}`;
                }
            }
            ...
            try {
                ...
                try {
                    ...
                    if (viewUrl.startsWith('/uploads/')) {
                        ...
                        cleanViewUrl = `https://campus-share-zeta.vercel.app${viewUrl.startsWith('/') ? '' : '/'}${viewUrl}`;
                    }
                }
                ...
                try {
                    ...
                    try {
                        ...
                        if (downloadUrl.startsWith('/uploads/')) {
                            ...
                            cleanFallbackUrl = `https://campus-share-zeta.vercel.app${downloadUrl.startsWith('/') ? '' : '/'}${downloadUrl}`;
                        }
                    }
