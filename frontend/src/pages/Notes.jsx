        ...
        try {
            ...
            try {
                ...
                if (downloadUrl.startsWith('/uploads/')) {
                    ...
                    cleanDownloadUrl = `ttps://campus-share.onrender.com${downloadUrl.startsWith('/') ? '' : '/'}${downloadUrl}`;
                }
            }
            ...
            try {
                ...
                try {
                    ...
                    if (viewUrl.startsWith('/uploads/')) {
                        ...
                        cleanViewUrl = `ttps://campus-share.onrender.com${viewUrl.startsWith('/') ? '' : '/'}${viewUrl}`;
                    }
                }
                ...
                try {
                    ...
                    try {
                        ...
                        if (downloadUrl.startsWith('/uploads/')) {
                            ...
                            cleanFallbackUrl = `ttps://campus-share.onrender.com${downloadUrl.startsWith('/') ? '' : '/'}${downloadUrl}`;
                        }
                    }
